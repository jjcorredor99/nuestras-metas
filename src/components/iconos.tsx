...
/** La marca de la app: el mismo corazón del ícono, en verde salvia. */
export function Marca({ tam = 84 }: { tam?: number }) {
  return (
    <svg className="marca-svg" width={tam} height={tam} viewBox="0 0 128 128" aria-hidden>
      <defs>
        <linearGradient id="marca-hoja" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0" stopColor="#9db794" />
          <stop offset="1" stopColor="#4f6b4c" />
        </linearGradient>
      </defs>
      <path
